...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/views/books/lists/lists.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("</table><script src=\"/estatico/js/removeLivro.js\">\r\n        </script> ");
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/views/books/lists/lists.marko",
    tags: [
